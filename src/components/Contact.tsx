          ...
          >
            {contactInfo.map((item, index) => (
              <motion.div
                ...
                className="glass rounded-xl p-6 text-center group hover:bg-gold/10 transition-colors"
              >
          ...
          >
            ...
            <div className="flex justify-center gap-6 md:gap-10 flex-wrap">
              {socialLinks.map((social, index) => (
                ...
                >
                  <div className="w-20 h-20 md:w-24 md:h-24 rounded-2xl bg-gold/10 flex items-center justify-center text-foreground group-hover:bg-gold group-hover:text-background transition-all duration-300 shadow-lg group-hover:shadow-gold/30">
                    {social.icon}
                  </div>
